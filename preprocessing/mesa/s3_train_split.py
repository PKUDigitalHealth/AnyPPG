...
if __name__ == '__main__':
    ...
    dataset_dir = './preprocessing/mesa/Proc_MESA_Patient_Level'
    train_ratio, valid_ratio, test_ratio = 0.8, 0.1, 0.1

    df = pd.read_csv('./preprocessing/mesa/logs/log.csv')
    ...
    shuffled_df.to_csv('./preprocessing/mesa/logs/split.csv', index=False)