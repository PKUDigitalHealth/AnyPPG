...
class Net1D(nn.Module):
    ...
    def __init__(self, in_channels: int, base_filters: int, ratio: float, filter_list: list, m_blocks_list: list, kernel_size: int, stride: int, groups_width: int, use_bn: bool = True, use_do: bool = True, verbose: bool = False):
