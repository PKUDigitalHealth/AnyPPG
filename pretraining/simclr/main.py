...
def parse_args():
    parser = argparse.ArgumentParser(
        prog='PPG-SimCLR',
        description='Pretraining PPG SimCLR',
    )
    ...
    parser.add_argument('--temperature', default=0.07, type=float, help='Temperature for NT-Xent loss')
    
    # WandB args
    parser.add_argument('--wandb_project', default='ppg-simclr', type=str, help='WandB project name')
...
def main():
    ...
    # --- Model Setup ---
    logger.info("Initializing SimCLR Model...")
