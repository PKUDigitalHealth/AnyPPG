...
def parse_args():
    parser = argparse.ArgumentParser(
        prog='AnyPPG',
        description='Pretraining PPG-ECG CLIP',
    )
    ...
    parser.add_argument('--emb_dropout', default=0.2, type=float, help='Dropout for embeddings')
    
    # WandB args
    parser.add_argument('--wandb_project', default='anyppg-kdd', type=str, help='WandB project name')
...
def main():
    ...
    cfg.model.emb_dropout = args.emb_dropout
    ...
    ppg_conf = PPGEncoderConfig() 
    ecg_conf = ECGFounderConfig()
