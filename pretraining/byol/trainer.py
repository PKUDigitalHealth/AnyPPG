        ...
        for epoch in range(self.start_epoch, self.epochs):
            ...
            for batch_idx, (_, ppg_view1, ppg_view2) in enumerate(train_loader, start=skip_batches): 
                ...
                with self.accelerator.accumulate(self.model):
                    ...
                    ppg_grad_norm = self._compute_grad_norm(unwrapped_model.online_encoder.parameters())
                    ...
                    # Need to unwrap model in case of DDP/Accelerator wrapping
                    self.accelerator.unwrap_model(self.model).update_target_network()
